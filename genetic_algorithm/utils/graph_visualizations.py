...
def remove_connections(classifier):
    ...
    # update sparsity
    if (classifier.sparse_linear1.in_features == 0 or classifier.sparse_linear1.out_features == 0):
    ...
    if (classifier.sparse_linear2.in_features == 0 or classifier.sparse_linear2.out_features == 0):
